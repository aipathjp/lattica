# Taible Playground (Next.js App Router)

A minimal Next.js App Router page that consumes the published Taible packages:
...
(`pnpm --filter @ai-path/tb-example-playground typecheck`), proving the public API
